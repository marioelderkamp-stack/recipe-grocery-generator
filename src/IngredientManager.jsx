    ...
    <Modal onClose={onClose}>
      <div style={{ background: "#F7F5EE", border: "1px solid #C9C2AE", borderRadius: 10, padding: 20 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          <h3 style={{ fontFamily: "'Abril Fatface', serif", fontWeight: 700, fontSize: 16, margin: 0 }}>Filteren</h3>
...
function NewIngredientModal({ draft, onChange, onCancel, onSubmit, error }) {
  ...
  return (
    <Modal onClose={onCancel}>
      <div style={{ background: "#F7F5EE", border: "1px solid #C9C2AE", borderRadius: 10, padding: 20 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          <h3 style={{ fontFamily: "'Abril Fatface', serif", fontWeight: 700, fontSize: 16, margin: 0 }}>Nieuw ingrediënt</h3>
  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
        <h2 style={{ fontFamily: "'Abril Fatface', serif", fontWeight: 700, fontSize: 21, margin: 0 }}>Ingrediënten beheren</h2>
